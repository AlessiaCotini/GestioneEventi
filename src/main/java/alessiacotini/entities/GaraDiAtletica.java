...
public class GaraDiAtletica extends Evento{
    ...
    public GaraDiAtletica(String titolo, LocalDate dataevento, String descrizione, TipoEvento tipoevento, int numeromax, List<Persona> set_atleti, Persona vincitore){
